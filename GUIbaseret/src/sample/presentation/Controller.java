...
public class Controller {
    ...
    public void initialize() {
        ...
        textLine3.setFont(Font.font("Dialog", FontWeight.BOLD, 11));
                ...
                if (numberOfMovement == 0) {
                    ...
                    if (Main.game.isRoom(Main.game.RoadBuild) && talkingRoadbuilder && spaceCount != 0) {
                        ...
                        if (roadBuilder.getDamaged() > 0 && !playerObject.getHaveToolset()) {
                            ...
                            textLine1.setFont(Font.font("Dialog", FontWeight.BOLD, 11));
                            textLine2.setTranslateY(-190);
                            textLine2.setFont(Font.font("Dialog", FontWeight.BOLD, 11));
                            textLine3.setTranslateY(-170);
                            textLine3.setFont(Font.font("Dialog", FontWeight.BOLD, 11));
                            ...
                            if (spaceCount == 0 && roadBuilder.getDamaged() > 0) {
                                ...
                                talkNPC(textLine2, "Road builder", 1);
                                talkNPC(textLine3, "Road builder", 2);
                                spaceCount++;
    ...
    public void repairTheMachine() {
        ...
        KeyFrame frame = new KeyFrame(Duration.millis(1000 / FPS), event -> {
            if (counterRepair % 60 == 0 && roadBuilder.getDamaged() > 0) {
                ...
                textLine2.setText(100 - roadBuilder.getDamaged() + "% repaired");
    ...
    private void endGame() {
        if (roadBuilder.getInventoryCount() >= Main.game.getRoadDone()) {
            ...
            textLine2.setTranslateY(0);
            textLine3.setTranslateY(85);
            textLine1.setText(scoreList[0]);
            textLine2.setText(scoreList[1]);
            textLine3.setText(scoreList[2]);
        ...
        if (Main.game.isRoom(Main.game.Farm)) {
            if (farmerTalked == 0) {
                if (spaceCount == 0 && !farmerTalk) {
                    ...
                    talkNPC(textLine2, "farmer", 1);
                    talkNPC(textLine3, "farmer", 2);
                    spaceCount++;
            ...
            if (spaceCount == 0 && !professorTalk) {
                ...
                talkNPC(textLine2, "professor", 1);
                talkNPC(textLine3, "professor", 2);
                spaceCount++;
            } else if (spaceCount == 1) {
